...
describe('Calculation-2024 Component', () => {
  ...
  describe('Tax Slab Generation', () => {
    test('should generate correct tax slabs for general taxpayer', () => {
      ...
      expect(slabs[0]).toEqual(['First Tk3.5 lakh', 0, 350000, 0]);
      expect(slabs[1]).toEqual(['Next Tk1 lakh', 350000, 450000, 5]);
      expect(slabs[2]).toEqual(['Next Tk4 lakh', 450000, 850000, 10]);
      expect(slabs[3]).toEqual(['Next Tk5 lakh', 850000, 1350000, 15]);
      expect(slabs[4]).toEqual(['Next Tk5 lakh', 1350000, 1850000, 20]);
      expect(slabs[5]).toEqual(['Next Tk20 lakh', 1850000, 3850000, 25]);
      expect(slabs[6]).toEqual(['Above', 3850000, Infinity, 30]);
    });
    ...
    test('should generate correct tax slabs for female taxpayer', () => {
      ...
      expect(slabs[0]).toEqual(['First Tk4.0 lakh', 0, 400000, 0]);
      expect(slabs[1]).toEqual(['Next Tk1 lakh', 400000, 500000, 5]);
      expect(slabs[2]).toEqual(['Next Tk4 lakh', 500000, 900000, 10]);
    });
    ...
    test('should generate correct tax slabs for disabled person', () => {
      ...
      expect(slabs[0]).toEqual(['First Tk4.8 lakh', 0, 475000, 0]);
      expect(slabs[1]).toEqual(['Next Tk1 lakh', 475000, 575000, 5]);
    });
  });
